...
<div class="grid grid-cols-3 gap-3">
  <RouterLink :to="`/${surah.number}`" v-for="surah in surahs?.data" class="flex gap-4 justify-between border-rounded border border-light dark:border-darkSecondary p-3 items-center bold">
